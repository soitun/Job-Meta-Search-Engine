...
*/
class CBAPI {
private static $APIKey = "WD4403S72D4VYWGQWRLZ"; /* your private CareerBuilder API Developer Key */
public static $perPage = 100; /* the number of job results to pull back for a results search */
public static $siteID = 'www.jmhtechsol.com/jobboard/'; /* optional string that can be used to track engagement */
								...
								foreach($xml->Results->JobSearchResult as $result)
									{
										...
										$currJob->LocationCity = (string)$result->LocationCity;
										$currJob->LocationState = (string)$result->LocationState;
										...
										$currJob->applyURL = (string)$result->JobDetailsURL;
										$currJob->companyDetailsURL = (string)$result->CompanyDetailsURL;
										$currJob->JobServiceURL = (string)$result->JobServiceURL;
										$currJob->posted = (string)$result->PostedDate;
										$jobsCollection[$currItem] = $currJob;
										$currItem ++;
									}
								if (!empty ($xml->Results->JobSearchResult))
									{
...
$xml = simplexml_load_file($url);
$retJob = new Job();
$retJob->did = (string)$xml->Job->DID."<br />";
$retJob->title = (string)$xml->Job->JobTitle."<br />";
$retJob->companyName = (string)$xml->Job->Company."<br />";
$retJob->city = (string)$xml->Job->LocationCity."<br />";
$retJob->state = (string)$xml->Job->LocationState."<br />";
$retJob->latitude = (string)$xml->Job->LocationLatitude."<br />";
$retJob->longitude = (string)$xml->Job->LocationLongitude."<br />";
$retJob->description = (string)$xml->Job->JobDescription."<br />";
$retJob->posted = (string)$xml->Job->PostedDate."<br />";
$retJob->categories = explode(',',(string)$xml->Job->Categories)."<br />";
$retJob->categoryCodes = explode(',',(string)$xml->Job->CategoriesCodes)."<br />";
$retJob->applyURL = (string)$xml->Job->ApplyURL."<br />";
$retJob->companyDetailsURL = (string)$xml->Job->CompanyDetailsURL."<br />";
...
$currJob->did = (string)$result->JobDID."<br />";
$currJob->title = (string)$result->Title."<br />";
$currJob->relevancy = (string)$result->Relevancy."<br />";
$currJob->companyName = (string)$result->Company->CompanyName."<br />";
$currJob->companyLink = (string)$result->Company->CompanyDetailsURL."<br />";
$currJob->locationCity = (string)$result->Location->City."<br />";
$currJob->locationState = (string)$result->Location->State."<br />";
$currJob->detailsLink = (string)$result->JobDetailsURL."<br />";
